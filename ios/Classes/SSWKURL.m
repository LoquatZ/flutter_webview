...
//    }
//    NSLog(@"========URL:%@",urlSchemeTask.request.URL);
    ...
    FlutterMethodChannel *_methodChannel = [FlutterInstance channelWithAgent:agent];
    if(_methodChannel != nil){
        NSString *url = mutableReqeust.URL.absoluteString;
        [_methodChannel invokeMethod:@"shouldInterceptRequest" arguments:@{@"url" : url}];
    }
}
